        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-6 py-12  relative overflow-hidden">
            ...
            <div className="w-full max-w-[1100px] grid grid-cols-1 lg:grid-cols-2 bg-white rounded-[3rem] shadow-2xl overflow-hidden relative z-10 border border-gray-100">
                ...
                <div className="hidden lg:block relative">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-orange-600/80 to-transparent flex flex-col justify-end p-12">
                        <Title level={2} className="!text-white !mb-4">Experience EatEase Dining</Title>
                ...
                <div className="p-12 md:p-16 flex flex-col justify-center">
                    <div className="mb-10">
                        ...
                        <Title level={2} className="!font-bold !mb-2">Sign In to EatEase</Title>
                        <Text className="!text-orange-500">Welcome back! Please enter your details.</Text>
                    </div>
                    ...
                    <Divider plain><Text className="text-gray-400 px-4">OR CONTINUE WITH</Text></Divider>

                    <div className="grid grid-cols-2 gap-4 mb-8">
                        <Button className="h-12 rounded-xl flex items-center justify-center gap-2 border-gray-200 hover:border-orange-500 hover:text-orange-500">
