...
const Hero = () => {
    return (
        <section className="relative min-h-[90vh] flex items-center pt-24 md:pt-32 overflow-hidden bg-white">
            ...
            <div className="container mx-auto px-6 lg:px-12 relative z-10">
                <Row gutter={[40, 40]} align="middle">
                    {/* Changed lg={12} to xl={12} for perfect scaling down to 1279px */}
                    <Col xs={24} xl={12}>
                        <div className="max-w-xl mx-auto xl:mx-0 text-center xl:text-left">
                            ...
                            {/* Adjusted responsive text sizes dynamically */}
                    ...
                    {/* Image Column adjusted for medium/small laptop viewports */}
                    <Col xs={24} xl={12}>
